...
class ClosedPrListAdapter @Inject constructor() : ListAdapter<ClosedPrUiModel, ClosedPrViewHolder>(MainDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClosedPrViewHolder {
        val viewBinding = LayoutInflater.from(parent.context).inflate(R.layout.closed_pr_list_item, parent, false)
    ...
    private class MainDiffCallback : DiffUtil.ItemCallback<ClosedPrUiModel>() {
        ...
        override fun areContentsTheSame(
            oldItem: ClosedPrUiModel,
            newItem: ClosedPrUiModel
        ): Boolean =
            oldItem == newItem
    }
}
